    ...
    >
      ...
      <div className="space-y-8">
        ...
        <motion.div
          ...
          className="bg-background/50 border rounded-lg p-6 hover:shadow-lg transition-shadow duration-300 mb-8"
        >
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {["Angular 15", "TypeScript", "Tailwind CSS", "SCSS", "REST APIs", "Git"].map(
                  (tech, i) => (
                    <span
                      key={i}
        ...
        >
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">{exp("ibcorp.leadershipDescription")}</p>

              <h4 className="font-medium text-foreground/80 mt-4 mb-3 flex items-center">
                <GitBranch className="w-5 h-5 mr-2 text-red-500" />
                {exp("ibcorp.methodologies")}
              </h4>
              <p className="text-gray-600 dark:text-gray-300">{exp("ibcorp.methodologiesList")}</p>
            </div>
          </div>
        </motion.div>
      </div>
